<?php
/**
 * Spar functions and definitions
 *
...
if ( ! function_exists( 'spar_setup' ) ) :
	...
	function spar_setup() {
		 ...
		 * If you're building a theme based on Spar, use a find and replace
		 * to change 'spar' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'spar', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'spar' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'spar_custom_background_args', array(
...
add_action( 'after_setup_theme', 'spar_setup' );
 ...
 */
function spar_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'spar_content_width', 640 );
}
add_action( 'after_setup_theme', 'spar_content_width', 0 );
 ...
 */
function spar_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'spar' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'spar' ),
...
add_action( 'widgets_init', 'spar_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'spar_scripts' );
